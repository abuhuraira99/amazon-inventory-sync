"""
Amazon Inventory Sync: keeps Amazon stock quantities in step with a vendor feed.
...
Package layout, in the order data flows:
    ...
    engine/         the decisions
        ...
        decision        the quantity rules
        guardrails      the circuit breakers
        pusher          send, then read back to confirm
        rollback        undo
        report_builder  the five .xlsx files produced each run
