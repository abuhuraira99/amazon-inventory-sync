...
def test_integer_format_specifiers_still_work():
    ...
    """
    assert _emit("processed %d rows in %.1f seconds", (1234567, 11.2)) == (
        "processed 1234567 rows in 11.2 seconds"
    )
...
def test_redact_leaves_ordinary_text_alone():
    ...
    line = "run 41: 12,345 quantities out of step, 196 products with zero stock"
