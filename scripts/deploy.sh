...
[ -f docker-compose.yml ] || die "run this from the amazon-inventory-sync directory"
[ -f .env ]               || die ".env is missing. Copy .env.example to .env and fill it in; see docs/DEPLOYMENT.md."
