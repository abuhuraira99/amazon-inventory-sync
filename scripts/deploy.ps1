...
[CmdletBinding()]
param(
    [string]$ServiceName = 'AmazonInventorySync',
...
if (-not (Test-Path -LiteralPath '.env')) { Stop-With ".env is missing. Copy .env.example to .env and fill it in; see docs/DEPLOYMENT.md." }
